...
##-----------------------------------------#
## Set dimensions
plot_width  <- 21*1.4 ## a4 paper
plot_height <- (plot_width/5*2)*1
unit   <- "cm" 
...
bimodalItemPlot <- plot_grid(
   ...
   get_legend(pBiDiscr + theme(legend.position = "bottom", legend.title = element_blank()))), rel_heights = c(1, .1), nrow=2)
